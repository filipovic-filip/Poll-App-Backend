...
// HasCreatedPolls applies the HasEdge predicate on the "created_polls" edge.
func HasCreatedPolls() predicate.User {
...
// HasCreatedPollsWith applies the HasEdge predicate on the "created_polls" edge with a given conditions (other predicates).
func HasCreatedPollsWith(preds ...predicate.Poll) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newCreatedPollsStep()
...
func HasVotesWith(preds ...predicate.PollOption) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newVotesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
